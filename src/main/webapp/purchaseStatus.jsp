...
<meta charset="UTF-8">
<title>BusCo</title>
<link rel="stylesheet" href="styles/stylePurchaseStatus.css"/>
...
<div class="footer">
   ...
   <% 
   		...
   		if(status.equals("success")){%> <script src="scripts/scriptSuccessPurchase.js"></script> <%}
   		else {%> <script src="scripts/scriptFailedPurchase.js"></script> <%}
   		%>
</div>
</body>
</html>
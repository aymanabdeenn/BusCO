...
public class dailyPassCalc extends fareCalc{
	
	public dailyPassCalc(fareConfig fare_config , String travelType , String category) {
		if(fare_config == null) System.out.println("An error occured while retrieving the fare_config object in the dailyPassCalc!");
			...
			this.fare = fare_config.getCityFare() + fare_config.getDailyFare();
			
		}
		else {
			this.fare = fare_config.getInnerCityFare() + fare_config.getDailyFare();

...
public class monthlyPassTicket implements Ticket{
	String type , user , purchaseDate , travelType , category;
	float price;
	int tripNumber;
	
	public monthlyPassTicket(String type , String user , String purchaseDate, String travelType , String category , int tripNumber) {
		this.type = type;
		this.user = user;
	...
	public void calcPrice(fareConfig fare_config) {
		monthlyPassCalc calc = new monthlyPassCalc(fare_config , travelType , category);
